...
\Oli{Amy and Troxel to write something here}
...
\end{summaryii}
 ...
 As described in our proposal, we are treating the WFIRST cluster cosmology
 program as essentially a subset of weak lensing.  Clusters can be identified
