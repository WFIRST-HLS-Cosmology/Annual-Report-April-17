...
\end{summary}
 ...
 \subsection{Developing the HLIS Requirements (D1)}
 ...
 \begin{summaryii}
   ...
   data reduction software, and the survey. Responding to a calendar set by the
...
\subsubsection{Science Requirements}
