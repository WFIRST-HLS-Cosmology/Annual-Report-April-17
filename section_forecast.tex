...
We begin the WFIRST HLIS section by forecasting the weak lensing science component only. We closely follow the weak lensing part of the forecasting machinery described in \cite{Krause16}. That is we model 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Modelling Weak lensing observables and covariances}
\label{sec:lensingbasics}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
All simulated likelihood analyses in this paper are computed using the weak lensing modules of \textsc{CosmoLike} \citep[see][for an early version; official release paper is Krause et al. 2014 in prep]{eks14}. 
