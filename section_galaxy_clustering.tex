...
\citep{Benson2012}, was used to predict the H${\rm \alpha}$-emitter number counts and redshift distributions for the
...
\citep{Springel05} with the \textsc{Galacticus} model. Emission lines
...
\citep{Ferland13} code and stored as a function of hydrogen (HI),
...
\begin{figure}
  ...
  \caption{Predictions for the cumulative H${\rm \alpha}$ flux counts
    ...
    the observed counts from WISP \protect\cite{Colbert13,Mehta:2015},
...
in size to 4 sq deg, in order to provide timely input to WFIRST. However, Merson et al. plan to build significantly larger lightcones in future work.
